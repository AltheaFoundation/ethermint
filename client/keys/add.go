...
func RunAddCmd(ctx client.Context, cmd *cobra.Command, args []string, inBuf *bufio.Reader) error {
	...
	keyTypeStr, _ := cmd.Flags().GetString(flags.FlagKeyType)
	...
	// ledger
	if useLedger {
		algo, err = keyring.NewSigningAlgoFromString(keyTypeStr, ledgerAlgos)
	} else {
		algo, err = keyring.NewSigningAlgoFromString(keyTypeStr, keyringAlgos)
	}
