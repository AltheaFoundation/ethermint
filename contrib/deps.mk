...
$(PROTOC_VERSION_FILE):
	...
	@cp -f $(BUILD_CACHE_DIR)/protoc/bin/protoc $(BINDIR)/protoc
...
$(BUF_VERSION_FILE):
	...
	@cp -f $(BUILD_CACHE_DIR)/buf/buf/bin/buf $(BINDIR)/buf
...
$(PROTOC_GEN_GOCOSMOS_VERSION_FILE):
	...
	GOBIN=$(ROOT_DIR)/$(BINDIR) $(GO_BIN) install ./protoc-gen-gocosmos
	@rm -rf $(BUILD_CACHE_DIR)/protoc-gen-gocosmos

PROTOC_GEN_GOCOSMOS := $(BINDIR)/protoc-gen-gocosmos
...
$(PROTOC_GEN_GRPC_GATEWAY_VERSION_FILE):
	...
	GOBIN=$(ROOT_DIR)/$(BINDIR) $(GO_BIN) install ./protoc-gen-grpc-gateway; \
	GOBIN=$(ROOT_DIR)/$(BINDIR) $(GO_BIN) install ./protoc-gen-swagger
	@rm -rf $(BUILD_CACHE_DIR)/protoc-gen-grpc-gateway

PROTOC_GEN_GRPC_GATEWAY := $(BINDIR)/protoc-gen-grpc-gateway
...
PROTOC_GEN_SWAGGER := $(BINDIR)/protoc-gen-swagger
...
$(PROTOC_GEN_DOC_VERSION_FILE):
	...
	@cp -f $(BUILD_CACHE_DIR)/protoc-gen-doc/protoc-gen-doc $(BINDIR)/protoc-gen-doc
	@rm -rf $(BUILD_CACHE_DIR)/protoc-gen-doc

PROTOC_GEN_DOC := $(BINDIR)/protoc-gen-doc
...
$(SWAGGER_COMBINE_VERSION_FILE):
	...
	@ln -sf ../.cache/node_modules/.bin/swagger-combine $(BINDIR)/swagger-combine

SWAGGER_COMBINE := $(BINDIR)/swagger-combine
